    ...
    $(document).ready(function() {
        ...
        dataTables = $('#table-result').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    render: function(response, row, type, meta) {
                        let button = '';
                        button += '<button type="button" class="btn btn-primary btn-sm btn-edit mr-2" data-id="' + response.artikel_category_id + '"><i class="fa fa-pen"></i> Ubah</button>';
                        button += '<button type="button" class="btn btn-danger btn-sm btn-delete" data-id="' + response.artikel_category_id + '" data-message-delete="Apakah anda yakin, Data tag : <b>' + response.nama_kategori + '</b> akan dihapus?"><i class="fa fa-trash-alt"></i> Hapus</button>';
                        return button;
                    }
                }
            ],
        ...
        function showForm(type = 'Simpan', id = '') {
            ...
            $bootbox = bootbox.dialog({
                title: type == 'Ubah' ? 'Ubah Artikel Kategori' : 'Tambah Artikel Kategori',
