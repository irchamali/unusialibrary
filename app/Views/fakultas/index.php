        ...
        dataTables = $('#table-result').DataTable({
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    render: function(response, row, type, meta) {
                        let button = '';
                        button += '<button type="button" class="btn btn-primary btn-sm btn-edit mr-2" data-id="' + response.fakultas_id + '"><i class="fa fa-pen"></i> Ubah</button>';
                        button += '<button type="button" class="btn btn-danger btn-sm btn-delete" data-id="' + response.fakultas_id + '" data-message-delete="Apakah anda yakin, Data : <b>' + response.nama_fakultas + '</b> akan dihapus?"><i class="fa fa-trash-alt"></i> Hapus</button>';
                        return button;
                    }
                }
            ],
