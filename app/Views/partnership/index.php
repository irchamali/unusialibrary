<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-4">
                    <a href="<?= base_url('admin/partnership/form'); ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    render: function(response, row, type, meta) {
                        return response.logo ? '<img src="<?= base_url('public/images/partnership/') ?>' + response.logo + '" class="btn-user-image" style="width:80px;height:80px;">' : '<img src="<?= base_url('public/images/no_image.png') ?>" class="btn-user-image" style="width:80px;height:80px;">';
                    }
                },
                {
                    mData: null,
                    title: 'Nama Partnership',
                    render: function(response, row, type, meta) {
                ...
                },
                {
                    ...
                    render: function(response, row, type, meta) {
                        let button = '';
                        let url = '<?= base_url('admin/partnership/form?id=') ?>' + response.id;
