    ...
    $(document).ready(function() {
        dataTables = $('#table-result').DataTable({
            ...
            "columns": [{
                ...
                {
                    mData: null,
                    title: 'Nama Link Terkait',
                    render: function(response, row, type, meta) {
                        return response.nama_terkait;
                    }
                },
                {
                    mData: null,
                ...
                },
                {
                    ...
                    render: function(response, row, type, meta) {
                        ...
                        button += '<button type="button" class="btn btn-danger btn-sm btn-delete" data-id="' + response.id + '" data-message-delete="Apakah anda yakin, Data : <b>' + response.nama_terkait + '</b> akan dihapus?"><i class="fa fa-trash-alt"></i> Hapus</button>';
                        return button;
                    }
                }
            ],
