<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-body">
            <div class="row">
                <div class="col-sm-4">
                    <a href="<?= base_url('admin/setting-slider/form'); ?>" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i> Tambah Data</a>
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    render: function(response, row, type, meta) {
                        let urlImage = '<?= base_url('public/images/slider/') ?>' + response.image;
                        let image = '<img src="' + urlImage + '" class="btn-user-image" style="width:80px;height:80px;">';
                        return image;
                    }
                },
                {
                ...
                },
                {
                    ...
                    render: function(response, row, type, meta) {
                        let button = '';
                        let url = '<?= base_url('admin/setting-slider/form?id=') ?>' + response.slider_id;
                        button += '<a href="' + url + '" class="btn btn-primary btn-sm mr-2""><i class="fa fa-pen"></i> Ubah</a>';
                        button += '<button type="button" class="btn btn-danger btn-sm btn-delete" data-id="' + response.slider_id + '" data-message-delete="Apakah anda yakin, Data slider : <b>' + response.title + '</b> akan dihapus?"><i class="fa fa-trash-alt"></i> Hapus</button>';
                        return button;
                    }
                }
            ],
